    ...
    <div className="sidebar">
        <TwitterIcon className="sidebar__twitterIcon" />
          ...
          <Link to="/Notifications" style={{textDecoration: 'none'}}>
            ...
            <button className='sidebarOptions--button' onClick={togglemoreModal}> <PendingOutlinedIcon /><h2>More</h2></button>
          {/* Button Tweet */}
          <button variant="outlined" className="sidebar__tweet" onClick={toggleModal}><p>
            Tweet</p>
          </button>
          <button className="sidebar__tweeticon" onClick={toggleModal} ><TwitterIcon /></button>

        {modal && (
          <div className="modal--background" >
            <div className='Tweetmodal'>
                <div className="Tweetmodal--container">
                    <button className='Tweetmodal--button' onClick={toggleModal}> <CloseOutlinedIcon  /></button>
                </div>
                <form>
